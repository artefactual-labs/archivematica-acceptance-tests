...
class ArchivematicaBrowserTransferAbilityError(base.ArchivematicaUserError):
    pass
...
class ArchivematicaBrowserTransferAbility(
    ...
    def remove_top_transfer(self, top_transfer):
        ...
        if not remove_control.count():
            raise ArchivematicaBrowserTransferAbilityError(
                "Unable to find the Remove control for the top transfer or ingest"
            )
