...
Feature: Transfer policy check
  ...
  Examples: Policy Check Outcomes
    ...
    | conform          | Completed successfully | pass           | successful          | TestTransfers/acceptance-tests/preforma/all-conform-policy-originals  | NYULib_MKVFFV1_MODIFIED.xml | Validation against a policy |
    | not conform      | Failed                 | fail           | failed              | TestTransfers/acceptance-tests/preforma/none-conform-policy-originals | NYULib_MKVFFV1_MODIFIED.xml | Validation against a policy |
