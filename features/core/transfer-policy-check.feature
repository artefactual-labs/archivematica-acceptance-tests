...
Feature: Transfer policy check
  ...
  Examples: Policy Check Outcomes
    ...
    | conform          | Completed successfully | pass           | successful          | ~/archivematica-sampledata/TestTransfers/acceptance-tests/preforma/all-conform-policy-originals  | NYULibraries_MKVFFV1-MODIFIED.xsl | Validation of Originals against a Policy |
    | not conform      | Failed                 | fail           | failed              | ~/archivematica-sampledata/TestTransfers/acceptance-tests/preforma/none-conform-policy-originals | NYULibraries_MKVFFV1-MODIFIED.xsl | Validation of Originals against a Policy |
