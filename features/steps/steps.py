...
@given('transfer {transfer_path} contains a processing config that does'
...
def step_impl(context, transfer_path):
    context.transfer_path = os.path.join(TRANSFERS_DIR, transfer_path)
