Feature: Ingest policy check
  ...
  Scenario Outline: Isla has preservation derivatives and she needs to know whether they conform to her preservation policy
    ...
    | conform          | Completed successfully | pass           | successful          | preforma/all-conform-policy  | NYULibraries_MKVFFV1-MODIFIED.xsl |
    | not conform      | Failed                 | fail           | failed              | preforma/none-conform-policy | NYULibraries_MKVFFV1-MODIFIED.xsl |
